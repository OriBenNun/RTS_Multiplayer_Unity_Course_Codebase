...
namespace Cameras
{
    public class MinimapTeleport : MonoBehaviour, IPointerDownHandler, IDragHandler
    {
        ...
        private void MoveCamera()
        {
            ...
            if (!RectTransformUtility.ScreenPointToLocalPointInRectangle(minimapRect, mousePos, null, out var localPoint))
            {
                return;
            }
